...
make_5_recofiles(gender, DATAPATH,embfile='known_80_raceeq_80_20_128.emb', pickfile_frn="known_80_raceeq_top100.pick", pickfile_str="known_80_rand.pick", testfile_suffix= "hada_100_test_raceeq.csv")

#sort_Reco(DATAPATH, testfile= "hada_100_test.csv", reco_file= "recommendations_1.csv")
sort_Reco(DATAPATH, testfile= "hada_100_test_raceeq.csv", reco_file= "recommendations_raceeq.csv")
...
write_topRecos(DATAPATH, growtharr=[0.20], testfile="hada_100_test_raceeq.csv", reco_file= "recommendations_raceeq.csv", toprecofile="topRecos_raceeq.edgelist")


print "#######################"
print "REGULAR"
print "#######################"
count_race_groups(race, DATAPATH, sorted_recos="recommendations.csv", testfile="hada_100_test.csv", growtharr=[0.2, 0.1, 0.05])
#makes race_testfile with race groups in the 4th column

print "#######################"
print "FAIRWALK"
print "#######################"
count_race_groups(race, DATAPATH, sorted_recos="recommendations_raceeq.csv", testfile="hada_100_test_raceeq.csv", growtharr=[0.2, 0.1, 0.05])
